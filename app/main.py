...
class AnalyzeRequest(BaseModel):
    ...
    max_pages: int = Field(12, ge=1, le=40, description="Maximum pages to crawl (keep low on free Render)")
    max_assets: int = Field(80, ge=1, le=200, description="Maximum assets (keep low on free Render)")
    ...
    depth: int = Field(1, ge=1, le=3, description="Crawl depth (1 recommended on free tier)")
