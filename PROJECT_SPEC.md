...
- Private API keys / secrets from the source site are **never** included in reconstruction ZIPs.
- User supplies their own keys via `.env` for any backend they rebuild.
